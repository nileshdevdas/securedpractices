package com.vinsys.securitylabs.jwtmanipulation.problem;
...
import com.vinsys.securitylabs.jwtmanipulation.JwtmanipulationUtils;
...
public class JwtManipulationProblemController {
	 @Autowired
	  ...
	  @Autowired
	  JwtmanipulationUtils jwtUtils;
	  
	  
	  @PostMapping("/JwtManipulation/problem/signin")
